...
6. Add targeted tests when behavior is introduced. Run pnpm run check and git diff --check, plus relevant production and visual checks. Record what could not be verified.
