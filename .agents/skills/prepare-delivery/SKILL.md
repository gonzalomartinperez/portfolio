...
2. Verify the relevant acceptance criteria and pnpm run check plus git diff --check. For dependency changes, also verify pnpm install --frozen-lockfile and pnpm audit.
